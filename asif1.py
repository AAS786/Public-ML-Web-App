...
if selected == 'Liver Prediction':
    ...
    Gender = convert_to_numeric(Gender, "Gender")
    ...
    if None in [Age, Gender, Total_Bilirubin, Direct_Bilirubin, Alkaline_Phosphotase, Alamine, Aspartate, Total_Proteins, Albumin, Albumin_Globulin_Ratio]:
