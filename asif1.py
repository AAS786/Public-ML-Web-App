...
# Loading the saved models
cancer_model = pickle.load(open(os.path.join(model_path, 'cancer_model.sav'), 'rb'))
heart_model = pickle.load(open(os.path.join(model_path, 'heart_model.sav'), 'rb'))
kidney_model = pickle.load(open(os.path.join(model_path, 'kidney_model.sav'), 'rb'))
liver_model = pickle.load(open(os.path.join(model_path, 'liver_model.sav'), 'rb'))
