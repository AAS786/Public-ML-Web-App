...
# Define the absolute path to the directory containing the models
model_dir = 'C:/Users/dell/Downloads/Multiple Disease/Saved'

# Loading the saved models
cancer_model_path = os.path.join(model_dir, 'cancer_model.sav')
heart_model_path = os.path.join(model_dir, 'heart_model.sav')
kidney_model_path = os.path.join(model_dir, 'kidney_model.sav')
liver_model_path = os.path.join(model_dir, 'liver_model.sav')
