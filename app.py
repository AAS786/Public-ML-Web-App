...
model_files = {
    'Cancer': 'Saved/cancer_model.sav',
    'Heart': 'Saved/Heart_model.sav',
    'Kidney': 'Saved/kidney_model.sav',
    'Liver': 'Saved/liver_model.sav',
    'Diabetes': 'Saved/diabetes_model.sav'
}
...
for model_name, model_path in model_files.items():
    if os.path.exists(model_path):
        ...
        st.error(f"Error loading {model_name} model: File not found at {model_path}")
...
st.markdown(
    ...
    .main {{
        ...
        background-color: white(255, 255, 255, 0.8); /* White background with 0.8 opacity */
    }}
    .title {{
        font-size: 40px;
        font-weight: bold;
...
if selected == 'Home':
    ...
    st.markdown("""
    <div class="container">
        <img src="https://i.postimg.cc/Y98nKRyK/Cancer.jpg" alt="Cancer" style="width:500px;height:auto;">
        <div>
    ...
    st.markdown("""
    <div class="container">
        <img src="https://i.postimg.cc/Qxzzd6Nj/Heart.jpg" alt="Heart Disease" style="width:500px;height:auto;">
        <div>
    ...
    st.markdown("""
    <div class="container">
        <img src="https://i.postimg.cc/jSNMdtkh/Diabetes.jpg" alt="Diabetes" style="width:500px;height:auto;">
        <div>
    ...
    st.markdown("""
    <div class="container">
        <img src="https://i.postimg.cc/1zrMwMSn/Liver.jpg" alt="Liver Disease" style="width:500px;height:auto;">
        <div>
    ...
    st.markdown("""
    <div class="container">
        <img src="https://i.postimg.cc/L4bDtncT/Kidney.jpg" alt="Kidney Disease" style="width:500px;height:auto;">
        <div>
